...
// ah note - code_gen/utils.cpp contains the implementations of the functions
// actually generating the various expressions in the code output

/*
 * a function that creates the vector of names to be appended together for a
 * var.
 */
...
// =
CCSTAssignOp *equals() { return new CCSTAssignOp(equal_t); }

// !
CCSTUnaryOp *Not() { return new CCSTUnaryOp(unary_bang_t); }

// &
CCSTUnaryOp *reference() { return new CCSTUnaryOp(unary_bit_and_t); }

CCSTUnaryOp *indirection() { return new CCSTUnaryOp(unary_mult_t); }
...
CCSTPostFixExprAssnExpr *function_call(const std::string &func_name,
