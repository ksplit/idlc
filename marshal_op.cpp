...
const static std::vector<std::string> cr_reg_store_mapping_ = {
    STORE_CREG(0), STORE_CREG(1), STORE_CREG(2), STORE_CREG(3),
    STORE_CREG(4), STORE_CREG(5), STORE_CREG(6), STORE_CREG(7)};
 ...
 * sets it as used
 */
Registers::Registers() : regs_(), cap_regs_() {}
...
Marshal_integer::Marshal_integer(int r) { this->register_ = r; }

void Marshal_integer::set_register(int r) { this->register_ = r; }

int Marshal_integer::get_register() { return this->register_; }
...
void Marshal_typedef::set_register(int r) { true_type_->set_register(r); }

int Marshal_typedef::get_register() { return this->true_type_->get_register(); }

Marshal_float::Marshal_float(int r) { this->register_ = r; }

void Marshal_float::set_register(int r) { this->register_ = r; }

int Marshal_float::get_register() { return this->register_; }

Marshal_double::Marshal_double(int r) { this->register_ = r; }

void Marshal_double::set_register(int r) { this->register_ = r; }

int Marshal_double::get_register() { return this->register_; }

Marshal_bool::Marshal_bool(int r) { this->register_ = r; }

void Marshal_bool::set_register(int r) { this->register_ = r; }

int Marshal_bool::get_register() { return this->register_; }
...
Marshal_type *MarshalPrepareVisitor::visit(ProjectionType *pt) {
  ...
  for(std::vector<ProjectionField*>::iterator it = fields.begin(); it !=
  fields.end(); it ++) { ProjectionField *pf = *it; if (pf == 0x0) { Assert(1 ==
  0, "Error: null pointer in MarshalPrepareVisit visit ProjectionType\n");
    }
