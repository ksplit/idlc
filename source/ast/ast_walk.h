...
namespace idlc {
	...
	*/
	...
	class ast_walk {
	public:
		bool visit_file(file& node) { return traverse(self(), node); }
		bool visit_module_def(module_def& node) { return traverse(self(), node); }
		bool visit_driver_file(driver_file& node) { return traverse(self(), node); }
		bool visit_driver_def(driver_def& node) { return traverse(self(), node); }
		bool visit_module_item(module_item& node) { return traverse(self(), node); }
		bool visit_proj_def(proj_def& node) { return traverse(self(), node); }
		bool visit_rpc_def(rpc_def& node) { return traverse(self(), node); }
		bool visit_proj_field(proj_field& node) { return traverse(self(), node); }
		bool visit_var_decl(var_decl& node) { return traverse(self(), node); }
		bool visit_type_spec(type_spec& node) { return traverse(self(), node); }
		bool visit_indirection(indirection& node) { return traverse(self(), node); }
		bool visit_type_stem(type_stem& node) { return traverse(self(), node); }
		bool visit_type_array(type_array& node) { return traverse(self(), node); }
		bool visit_array_size(array_size& node) { return traverse(self(), node); }
		bool visit_type_proj(type_proj& node) { return traverse(self(), node); }
		bool visit_type_rpc(type_rpc& node) { return traverse(self(), node); }
		bool visit_naked_proj_decl(naked_proj_decl& node) { return traverse(self(), node); }
		bool visit_rpc_item(rpc_item& node) { return traverse(self(), node); }
		bool visit_type_none(type_none) { return true; }
		bool visit_type_casted(type_casted& node) { return traverse(self(), node); }
