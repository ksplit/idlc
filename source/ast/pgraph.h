...
namespace idlc {
    ...
    using passed_type = std::variant<primitive, none, node_ref<null_terminated_array>, node_ref<static_array>,
        node_ref<dyn_array>, node_ref<pointer>, node_ref<casted_type>, node_ref<rpc_ptr>, node_ref<projection>,
