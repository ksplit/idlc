...
namespace idlc {
    ...
    */
    template <marshal_side side> static constexpr bool should_bind(const annotation_set& ann)
    {
        switch (side) {
        case marshal_side::caller:
    ...
    template <marshal_side side> class unmarshaling_walk : public generation_walk<unmarshaling_walk<side>> {
    public:
